...
❒═════════════════╾❒`			
				...
				Fg.sendMessage(from, buffer, image, {quoted: freply, caption: infomp3})
				Fg.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:freply, caption: '꧁❦︎⃢⃝✞︎𝐉𝐡𝐨𝐞𝐥♡︎✞︎⃢⃝❦︎꧂'})
					addFilter(from)
          break 
...
case 'update':
if (!isOwner) return reply(ownerB())
reply(`✰ Espere un momento el bot se está actualizando`)
